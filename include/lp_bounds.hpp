...
double LP_LB(dist_t&, int64_t, double, int64_t, std::vector<double>, std::vector<double>, std::string);

double LP_UB(dist_t&, int64_t, double, int64_t, std::vector<double>, std::vector<double>, std::string);
